...
export default function TaskDetailsPanel({
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 bg-black/50 flex items-center justify-center z-[9999] p-4" style={{ margin: 0, padding: '1rem', width: '100vw', height: '100vh' }}>
